...
Note Radar is an Obsidian plugin that automatically tracks view statistics for the notes in your vault. It helps you understand which notes you revisit most often, which notes have never been opened, and how your vault activity changes over time.
...
**Tracking Views:** Enable the plugin and open any Markdown note. Note Radar will automatically increment that note's view count.
...
**Exporting Data:** Use the **Export statistics JSON** command from the Command Palette. The plugin creates a `note-radar-export-YYYY-MM-DD.json` file in your vault.
